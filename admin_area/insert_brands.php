...
if(isset($_POST['insert_brand'])){
  ...
  if($result){
    echo "<script>alert('brand has been inserted successfull')</script>";
  }
...
<input type="submit" class=" bg-info border-0 p-2 my-3" name="insert_brand" value="insert brand" aria-label="Username" aria-describedby="basic-addon1" required="required" >
